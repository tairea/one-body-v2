...
<template>
  ...
  >
    ...
    <!-- BUTTONS -->
    <v-tooltip text="Available on the 18th August 2025" location="right">
      <template v-slot:activator="{ props }">
        <div id="global-distribution" class="button disabled" v-bind="props">
    ...
    <v-tooltip text="Available on the 18th August 2025" location="right">
      <template v-slot:activator="{ props }">
        <div id="members" class="button disabled" v-bind="props">
    ...
    <v-tooltip text="Available on the 18th August 2025" location="right">
      <template v-slot:activator="{ props }">
        <div id="ai-summary" class="button disabled" v-bind="props">
    ...
    <div class="event-description mt-4">
      <h2>
        ...
        <br /><br />
        In the meantime, add to your profile — every story we share helps weave
        the network and make our connections stronger.
        <br /><br />
    ...
    .countdown-display {
      ...
      .countdown-item {
        ...
        .countdown-number {
          ...
          text-align: center;
          font-family:
            "Orbitron", "Audiowide", "Rajdhani", "Exo 2", "Chakra Petch",
            monospace;
        }
