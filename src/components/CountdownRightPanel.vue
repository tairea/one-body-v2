...
<template>
  ...
  >
    <div v-if="props.person">
      ...
      <h3>Thanks for completing your profile</h3>
      ...
      <div class="profile-section">
        ...
        <div class="button" @click="handleToggleNodeLabels">
          ...
          />
          <p class="b1">
            {{ appStore.showNodeLabels ? "Hide" : "Show" }} Node Labels
          </p>
        </div>
        ...
        <div
          ...
          class="button save-positions-button"
        ...
        >
          ...
          />
          <p class="b1">
            {{ isSavingPositions ? "Saving..." : "Save New Node Positions" }}
          </p>
        </div>
      </div>
    </div>
